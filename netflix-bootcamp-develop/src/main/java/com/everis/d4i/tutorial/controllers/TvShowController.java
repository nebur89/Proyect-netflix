...
public interface TvShowController {
	...
	NetflixResponse<String> renameTvShow(TvShowRest tvShowRest) throws NetflixException;
	NetflixResponse<String> deleteTvShow(TvShowRest tvShowRest) throws NetflixException;
